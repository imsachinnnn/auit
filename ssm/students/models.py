...
class PersonalInfo(models.Model):
    ...
    # This field will store the user's selection from the Caste model
    #caste = models.ForeignKey(Caste, on_delete=models.SET_NULL, blank=True, null=True)
    # You can keep this field in case you want an "Other" text input

    caste = models.ForeignKey(Caste, on_delete=models.SET_NULL, blank=True, null=True)
    caste_other = models.CharField(max_length=100, blank=True, null=True) # For custom input
